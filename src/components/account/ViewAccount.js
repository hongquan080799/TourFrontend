...
export default function ViewAccount() {
    ...
    const handleSubmit = async()=>{
      try { 
         ...
         const res = await khachhangApi.updateKhachhang(dataUpdate)
    ...
    return (
        <div>
            {!changePass?
            <div className="card" style={{width: '80%', margin:'auto', marginTop:100}}>
                <div className="card-header bg-info text-white">THÔNG TIN TÀI KHOẢN</div>
              <div className="card-body">
               Tên khách hàng
               <input type="text" className="form-control mb-2 mr-sm-2" value={userUpdate?.tenkh} name="ten" onChange={handleInputChange} />
               Giới tính
               ...
               CMND/CCCD
               <input type="text" className="form-control mb-2 mr-sm-2" value={userUpdate?.cmnd} name="cmnd" onChange={handleInputChange}/>
               Địa chỉ
            ...
            :
            <div className="card" style={{width: '50%', margin:'auto', marginTop:100}}>
              <div className="card-body">
                ...
                <button className="btn btn-info mr-4 mt-3" type="button" onClick={submitChangePass} >Xác nhận</button>
                <button className="btn btn-outline-info mr-4 mt-3" type="button" onClick={()=> setChangePass(false)}>Thoát</button>
              </div>
            </div>
            }
        </div>
